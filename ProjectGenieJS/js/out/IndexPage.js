...
var ThreadPage = (function (_super) {
    ...
    ThreadPage.prototype.render = function () {
        ...
        }}, "Send"), React.createElement("input", {style: inputStyle, placeholder: "Enter message", type: "text", onKeyPress: this.textKeyDown, className: "win-textbox"})));
    };
    return ThreadPage;
}(React.Component));
...
var App = (function (_super) {
    ...
    function App(props) {
        ...
        this.state = {
            pages: [{ page: Page.Profile, data: { id: "0" } }],
            selectedSection: 0
        };
    }
    App.prototype.render = function () {
        ...
        return React.createElement("div", null, React.createElement("div", {style: { background: "white", zIndex: this.state.selectedSection == 0 ? "99" : "0", marginLeft: "50px", position: "absolute", left: "0", top: "0", bottom: "0", right: "0" }}, content), React.createElement("div", {style: { zIndex: this.state.selectedSection == 1 ? "99" : "0", background: "Red", marginLeft: "50px", position: "absolute", left: "0", top: "0", bottom: "0", right: "0" }}), React.createElement("div", {style: barStyle}, React.createElement("i", {onClick: this.back, className: "fa fa-arrow-left", style: {
